...
★**自然な日本語**で書いてください。とくに after と one_point.action は、
  そのまま声に出す文章です。社会人がお客様に話す言葉として不自然でないか、
  書いたあとに一度読み返してください（助詞の誤り・二重敬語・意味の通らない語を残さない）。
...
- one_point（次に直す1点）が最重要の出力。**この商談で最も受注に効いた欠け**を1つだけ選ぶ。
  ...
  - action は **headline と同じ軸**にする。「背景を深掘る」が課題なら、暮らし・使い方・
    困りごとを聞く質問にする。別の話題にすり替えない。
  - **お客様の言葉を引用して聞き返すセリフは書かない**。聞き取りが間違っていると
    「小宮山様のおっしゃる『最低面積』とは」のように、言っていない言葉を本人に
    ぶつけることになる。誰にでも成り立つ聞き方（「どのようにお使いになりたいですか」等）にする。
  - reason は**その場面で実際に何が起きたか**を書く。「〜が重要です」という一般論で
    終えない（それはアドバイスであって理由ではない）。
