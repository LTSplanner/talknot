...
_MESSAGES = [
    ...
    "🎙️ {name}さん、今日の1本はこれからですね。\n\n"
    "やる気を待つより、先に口を動かすほうが早いです。5分で大丈夫。\n"
    "今日のぶん、いきましょう。",

    "🎙️ {name}さん、今日のロープレがまだです。\n\n"
    "うまい人ほど、地味に毎日やっています。5分で十分。\n"
    "1本だけ、置いていきましょう。",

    "🎙️ {name}さん、5分だけ、今日の1本を。\n\n"
    "うまくいかなくても大丈夫。やった事実だけが残ります。\n"
    "毎日の積み重ねが効いてきます。",

    "🎙️ {name}さん、今日の練習、まだ空いています。\n\n"
    "気分がのらない日は、短くていいので声を出すだけでも。\n"
    "毎日ふれることが、いちばん効きます。",

    "🎙️ {name}さん、今日の1本、先にすませませんか。\n\n"
    "あとに回すほど重くなります。5分で大丈夫です。\n"
    "今日のうちに、ひとつ。",

    "🎙️ {name}さん、まだ今日のぶんが残っています。\n\n"
    "完璧じゃなくていいので、ひととおり話しきるところまで。\n"
    "毎日つづけた人が、いちばん伸びます。",

    "🎙️ {name}さん、今日のロープレはお済みですか？\n\n"
    "詰まっても大丈夫。詰まる場所が分かるのが収穫です。\n"
    "毎日1本、いきましょう。",

    "🎙️ {name}さん、今日の1本がまだですね。\n\n"
    "上手さは要りません。5分、声に出すだけで十分です。\n"
    "今日のぶんを置いていきましょう。",

    "🎙️ {name}さん、あと5分、今日の練習に使えませんか。\n\n"
    "出来ばえは気にしなくて大丈夫です。\n"
    "毎日ちいさく続けるのが、いちばん効きます。",

    "🎙️ {name}さん、今日のロープレ、まだ空いています。\n\n"
    "忙しい日ほど短くていいので、1本だけ。\n"
    "毎日の1本が、来月の自分をつくります。",

    "🎙️ {name}さん、今日のぶんがこれからですね。\n\n"
    "うまくいかなくても大丈夫、それも記録になります。\n"
    "今日も1本、いきましょう。",

    "🎙️ {name}さん、まだ今日の1本が残っています。\n\n"
    "気合いは要りません。5分だけ、いつもの練習を。\n"
    "毎日やっている人ほど、本番が軽いです。",

    "🎙️ {name}さん、今日のロープレはこれからですか？\n\n"
    "完璧じゃなくていいので、まず口に出すところまで。\n"
    "1日空けると、戻すのに時間がかかります。",

    "🎙️ {name}さん、今日の1本、5分でどうぞ。\n\n"
    "途中で止まっても大丈夫です。練習はそのためにあります。\n"
    "毎日の積み重ねが効いてきます。",

    "🎙️ {name}さん、今日の練習がまだですね。\n\n"
    "思い出せなくても大丈夫。開けば思い出します。\n"
    "毎日ふれるほど、ことばが出てきます。",

    "🎙️ {name}さん、今日のぶん、まだ空いています。\n\n"
    "短くていいので、今日のうちに1本。\n"
    "毎日つづけると、商談で慌てなくなります。",

    "🎙️ {name}さん、今日のロープレはまだですね。\n\n"
    "出来ばえより、やったかどうかです。5分で十分。\n"
    "今日も1本、いきましょう。",

    "🎙️ {name}さん、あと5分だけ、今日の1本を。\n\n"
    "うまく言えなくて大丈夫。回数がことばを連れてきます。\n"
    "毎日ちいさく、続けていきましょう。",
]
